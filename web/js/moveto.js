function moveto_sa() {
    document.getElementById("iframe_main").setAttribute("src", "html/section_add.html");
}
...
function moveto_cs() {
    document.getElementById("iframe_main").setAttribute("src", "html/chart_section.html");
}
